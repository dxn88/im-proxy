...
import com.dxn.im.netty.server.handler.AutoFlushHandler;
...
public class ConnectionDescriptor {
    ...
    public boolean assignState(ConnectionState expected, ConnectionState newState) {
        ...
        if (!retval) {
            LOG.error("Unable to update state of connection descriptor."
                    + " MqttclientId = {}, expectedState = {}, newState = {}.", clientID, expected, newState);
        }
        return retval;
    }
